.PHONY: clean data lint requirements sync_data copy_data
...
REMOTE_PATH = /Data/sources/deep-learning
REMOTE_DRIVE = google
PROJECT_NAME = deeplearning-sandbox
...
sync_data:
	rclone sync data/ $(REMOTE_DRIVE):$(REMOTE_PATH)
